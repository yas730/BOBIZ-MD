...
module.exports = {
    ...
    FOOTER: process.env.FOOTER === undefined ? 'yaser bot  instagram.com/noureddine_ouafy تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🐶 yaser 𝙱𝙾𝚃 𝙼𝙳 https://www.instagram.com/8xas_h  🐕' : process.env.CAPTION,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? 'yaser' : process.env.STIC_WM,
};
